...
Functionality:- Exposes Rest API endpoints that user can call directly to fetch rewards summary.

Service Layer:- 
Computes reward points based on defined business criteria.
